        ...
        paths: {
            ...
            '/inventory/update': {
                put: {
                    ...
                    responses: { '200': { description: 'Inventory updated successfully' } }
                }
            }
        }
    },
...
app.get('/inventory/:productId', async (req, res) => {
    try {
        ...
        else res.status(404).json({ message: 'Product ID not found in inventory' });
    } catch (error) {
...
app.get('/', (req, res) => res.send('Inventory Microservice is online and healthy.'));
